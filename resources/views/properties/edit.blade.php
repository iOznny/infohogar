        ...
        <div class="col-12">
            <div class="card shadow mb-3">
                <div class="card-header py-3">
                    <div class="row">
                        <div class="col-10">
                            <p class="m-0 font-weight-bold">Actualizar Propiedad</p>
                        </div>
                    </div>
                </div>

                <div class="card-body">
                    <form action="{{ route('properties.update', $properties->id) }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="Inmueble" name="title" id="title" pattern="[a-zA-Z]{3-20}" oninput="maxlogStr(this);" maxlength="20" required value="{{ $properties->title }}"/>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="Dirección del inmueble" name="address" id="address" pattern="[a-zA-Z]{3-50}" oninput="maxlogStr(this);" maxlength="50" required value="{{ $properties->address }}"/>
                                        <div class="valid-feedback">¡Correcto!</div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select  class="form-control" name="state" id="state" required>
                                            ...
                                            @if($properties->state == "Aguascalientes")
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control" name="municipality" id="municipality" required>
                                            ...
                                            @if($properties->municipality == "Aguascalientes")
                                                <option value="Aguascalientes" selected>Aguascalientes</option>
                                                <option value="Asientos">Asientos</option>
                                            @else 
                                                <option value="Aguascalientes">Aguascalientes</option>
                                                <option value="Asientos" selected>Asientos</option>
                                            @endif
                                        </select>
                                        <div class="valid-feedback">¡Correcto!</div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select  class="form-control" name="typepost" id="typepost" required>
                                            ...
                                            @switch($properties->typepost)
                                                @case('Rentar')
                                                    <option value="Rentar" selected>Rentar</option>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="number" placeholder="Precio sin decimales, puntos o otro caracter." min="1" max="9999999" name="price" id="price" pattern="[0-9]{10}" oninput="maxlogStr(this);" maxlength="10" required value="{{ $properties->price }}"/>
                                        <div class="valid-feedback">¡Correcto!</div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select class="form-control" name="currency" id="currency" required>
                                            ...
                                            @if($properties->currency == "Aguascalientes")
                                            ...
                                            @else 
                                                ...
                                                <option value="Peso Uruguayo" selected>Peso Uruguayo</option>
                                            @endif
                                        </select>
                                        <div class="valid-feedback">¡Correcto!</div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control" style="resize: none;" name="description" id="description" rows="5" cols="10" oninput="maxlogStr(this);" maxlength="300" required>{{ $properties->description }}</textarea>
                                        <div class="valid-feedback">¡Correcto!</div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control" type="text" name="typeproperty" id="typeproperty" required>
                                            ...
                                            @if($properties->typeproperty == "Casa")
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-4 col-lg-3">
                                                <label class="label">
                                                    ...
                                                    <input class="form-control" type="file" name="picture1" id="picture1" />
                                                    <div class="valid-feedback">¡Correcto!</div>
                                                ...
                                                <label class="label">
                                                    <i class="far fa-file mt-3"></i><br>
                                                    <span>Agregar foto</span>
                                                    <input class="form-control" type="file" name="picture2" id="picture2" />
                                                    <div class="valid-feedback">¡Correcto!</div>
                                                    <div class="invalid-feedback">Por favor agregue una foto.</div>
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-md-4 col-lg-3">
                                                <label class="label">
                                                    <i class="far fa-file mt-3"></i><br>
                                                    <span>Agregar foto</span>
                                                    <input class="form-control" type="file" name="picture3" id="picture3" />
                                                    <div class="valid-feedback">¡Correcto!</div>
                                                    <div class="invalid-feedback">Por favor agregue una foto.</div>
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-md-4 col-lg-3">
                                                <label class="label">
                                                    <i class="far fa-file mt-3"></i><br>
                                                    <span>Agregar foto</span>
                                                    <input class="form-control" type="file" name="picture4" id="picture4" />
                                                    <div class="valid-feedback">¡Correcto!</div>
                                                    <div class="invalid-feedback">Por favor agregue una foto.</div>
                                                </label>
                                            </div>
